...
Figure \@ref(fig:first_app) below shows an app with an **actionButton()**, the input value of the app changes but the reactivity graph stays the same. The reactive graph does not capture the connection between the *unnamed observer* and the *input*.


```{r first_app, echo = FALSE, out.width = NULL, fig.cap = "App with an input, an actionButton() and an output"}
...
Figure \@ref(fig:diagram2) App diagram (graph)
